...
def run_training_pipeline(model_cls, experiment_name, cfg, model_kwargs=None):
    ...
    for model_number in cfg.model_range:
        ...
        extra_loss_arrays = [
            ...
            "MSE_characteristic_dynamics_over_training",
            "MSE_characteristic_plus_over_training",
            "MSE_characteristic_minus_over_training",
            "MSE_swe_dynamics_over_training",
            "MSE_swe_dynamics_eta_over_training",
            "MSE_swe_dynamics_u_over_training",
            "MSE_swe_dynamics_step_over_training",
            "MSE_swe_dynamics_anchor_over_training",
